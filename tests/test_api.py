...
def test_iter_descriptions():
    ...
    descriptions_data_true = [
        {'description': set(), 'extent': {'g1','g2'}, 'support': 2, 'delta-stability': 0},
        {'description': {'a'}, 'extent': {'g1'}, 'support': 1, 'delta-stability': 0},
        {'description': {'b'}, 'extent': {'g1','g2'}, 'support': 2, 'delta-stability': 1},
        {'description': {'c'}, 'extent': {'g2'}, 'support': 1, 'delta-stability': 0},
        {'description': {'a', 'b'}, 'extent': {'g1'}, 'support': 1, 'delta-stability': 1},
        {'description': {'a', 'c'}, 'extent': set(), 'support': 0, 'delta-stability': 0},
        {'description': {'b', 'c'}, 'extent': {'g2'}, 'support': 1, 'delta-stability': 1},
        {'description': {'a', 'b', 'c'}, 'extent': set(), 'support': 0, 'delta-stability': 0},
    ]
